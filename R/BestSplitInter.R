BestSplitLocalInter <- function( variable, target, measure_parent, min_obs, type, entropy_par, cp, indexes, n_cores, weights, cost, overfit ){
...
BestSplitGlobalInter <- function( data, Y_name, measure_parent, min_obs, type, entropy_par, cp, indexes, n_cores, weights, cost, overfit ) {
  ...
  best_splits_local <- sapply( colnames(data)[X_variables], function(x){
      ...
      BestSplitLocalInter( data[,x], data[,Y_name], measure_parent, min_obs, type, entropy_par, cp, indexes, n_cores, weights, cost, overfit )
